...
public class sample extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaycustomertextview = (TextView)findViewById(R.id.customerdisplay);
        ...
        setcustomerbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                displaycustomertextview.setText("customer name:     "+customername.getText().toString()+"\n" +"shopname:     "+shopname.getText().toString()+
        ...
        savecustomerbutton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                boolean isInserted = mydb.insertcustomer(customername.getText().toString(),shopname.getText().toString(),
                        customeraddress.getText().toString(),area.getText().toString(),customerph1.getText().toString(),
                        customerph2.getText().toString());
                if(isInserted = true)
                {
                    Toast.makeText(sample.this, "company "+customername.getText().toString() +" is added",Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(sample.this, "company "+customername.getText().toString() +" could not be added",Toast.LENGTH_LONG).show();
                }
                clear();
                displaycustomertextview.setText("");
            }
        });
